...
bind("ALT + up", sh("~/.config/hypr/scripts/move-window-guarded.sh up"))
bind("ALT + down", sh("~/.config/hypr/scripts/move-window-guarded.sh down"))
bind("ALT + left", sh("~/.config/hypr/scripts/move-window-guarded.sh left"))
bind("ALT + right", sh("~/.config/hypr/scripts/move-window-guarded.sh right"))
